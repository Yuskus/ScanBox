...
namespace DatabaseModel.Migrations
{
    ...
    [Migration("20241006135457_ShipmentsAdded")]
    partial class ShipmentsAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseModel.SuppilerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("suppilers_table", (string)null);
                });
            ...
            modelBuilder.Entity("DatabaseModel.ProductUnitEntity", b =>
                {
                    ...
                    b.HasOne("DatabaseModel.SuppilerEntity", "Supplier")
                        .WithMany("ProductUnits")
            ...
            modelBuilder.Entity("DatabaseModel.SuppilerEntity", b =>
                {
                    b.HasOne("DatabaseModel.CounterpartyEntity", "Counterparty")
                        .WithOne("Suppiler")
                        .HasForeignKey("DatabaseModel.SuppilerEntity", "CounterpartyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
